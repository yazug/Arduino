...
/**************************************************************************/
/*
 * Modified to work w/ Arduino SPI library by Sin.
 */
...
class Adafruit_PN532_SPI {
public:
	Adafruit_PN532_SPI(const uint8_t cs = SS);
	void begin(void);
	...
	// ISO14443A functions
	boolean readPassiveTargetID(uint8_t cardbaudrate, uint8_t * uid,
			uint8_t * uidLength);
...
//	void spiwrite(const uint8_t & c);
//	uint8_t spiread(const uint8_t & c = 0);
