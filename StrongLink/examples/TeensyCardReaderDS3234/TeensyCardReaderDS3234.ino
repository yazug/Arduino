...
<<<<<<< HEAD
const byte pin_OUT = 9;
const byte pin_IN = 12;
StrongLinkI2C rfid(StrongLinkI2C::SL018_ADDRESS, pin_OUT, pin_IN);
=======
const byte pin_tagsta = 9;
StrongLinkI2C rfid(StrongLinkI2C::SL018_ADDRESS, pin_tagsta, 13);
>>>>>>> DS3234
